...
export function SidebarDocumentsNav({
  ...
  const activeDocuments = useMemo(
    () => documents.filter((document) => !document.deletedAt && !document.isArchived),
    [documents],
  );
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-4">
      ...
      <div className={cn("space-y-2", collapsed ? "px-0.5" : "px-1")}>
        ...
        <div className={cn("flex flex-wrap gap-1", collapsed && "justify-center")}>
          <UtilityLink
            href="/docs"
          ...
          <UtilityLink
            ...
            icon={<StarIcon filled={isDocsIndex && currentView === "favorites"} />}
            onNavigate={onNavigate}
          />
          <UtilityLink
