    ...
    <div className="flex w-full flex-col px-4 py-5 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
      ...
      <section className="flex min-h-0 flex-1 flex-col gap-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <form action="/docs" className="flex w-full max-w-xl items-center gap-2 lg:justify-end">
            {currentView !== "all" ? (
            ...
            {query ? (
              <Link
                href={currentView === "all" ? "/docs" : `/docs?view=${currentView}`}
        ...
        <div className="flex flex-wrap items-center gap-2">
          {([
            ...
            return (
              ...
              >
                {label}
                <span className={cn("text-xs", active ? "text-white/72" : "text-muted-soft")}>
                  {counts[view]}
                </span>
              </Link>
            );
        ...
        {documents.length === 0 ? (
          ...
          <div className="flex min-h-[220px] flex-col items-center justify-center gap-2 px-6 text-center">
            <p className="text-base font-medium text-foreground">没有匹配的页面</p>
